            ...
            <div class="main-section main-center main-section-border single-register">
                ...
                <form class="form-horizontal" method="post" action="/register" id="sign-up-frm">
                        ...
                        <div class="form-group col-12">
                            ...
                            <div class="col-9 f-input level-list" id="level-list">
                                ...
                                <select id="examid" name="examid" class="form-control" data-toggle="tooltip"
                                    title="Chọn cấp độ kiểm tra từ danh sách">
                                    <option value="">Vui lòng chọn cấp độ kiểm tra</option>
                    ...
                    <div class="form-group col-12 button-group">
                        <button type="button" class="btn btn-primary btn-lg save-button" id="validateFormBtn">ĐĂNG
                            KÝ</button>
                    </div>
                </form>
            </div>
