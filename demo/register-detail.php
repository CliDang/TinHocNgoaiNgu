    ...
    <div class="container-content">       
        <div class="panel-heading">
           <div class="panel-title text-center">
                <h1 class="title">TRA CỨU THÔNG TIN ĐĂNG KÝ<br><div style="text-transform: none;font-size: 15px;">(Dành cho thí sinh đăng ký tự do)</div></h1>
            </div>
        </div> 
        <div class="main-section main-center main-section-border">        
            <form class="form-horizontal" method="post" action="/register-detail" id="tracuu_frm">
                

                <div class="title-section">Thông tin đăng ký:</div>
                <div class="info1-section">                     
                    <div class="form-group col-6">
                        <label for="name" class="col-6 control-label">Họ và tên thí sinh: <span class="required">(*)</span></label>
